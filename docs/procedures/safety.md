...
6. A **ROS-independent physical E-stop** is recommended (not confirmed present yet — see [../hardware/power.md](../hardware/power.md)).
...
Full details: [../hardware/power.md](../hardware/power.md).
...
- ⚠️ Do **not** kill the LiDAR driver brutally mid-scan (it gets stuck → unplug/replug). See
  [../hardware/lidar.md](../hardware/lidar.md).
