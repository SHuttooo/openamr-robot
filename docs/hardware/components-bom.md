...
- Speed command: internal knob (**VAR/AI1**), external **analog 0–5/10 V**, or **PWM 0–20 kHz** → on this
  robot the Teensy PWM goes to **VAR/AI2** (SW2=ON selects AI2). See [wiring-pinout.md](wiring-pinout.md).
...
- **12 V, 7 Ah** sealed lead-acid (AGM). A pair in series = **24 V 7 Ah**. Sags under load (see
  [power.md](power.md)). ⚠️ No fuse / no disconnect currently — see the safety gaps in [power.md](power.md).
