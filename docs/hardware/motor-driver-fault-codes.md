...
- Note: a *charged but weak* battery can still trip code 10 **under load** ("voltage drop / fast
  ...
  ([raspberry-pi power](raspberry-pi.md) / [power.md](power.md)): keep the battery healthy + ≥ 25 V, with
  short, thick 24 V wiring.
...
See also: [motors-drivers.md](motors-drivers.md) (driver model, DIP switches, pots), [power.md](power.md)
(battery / 24 V), [history/diagnostics.md](../history/diagnostics.md).
